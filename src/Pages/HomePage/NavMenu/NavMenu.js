...
const NavMenu = () => {
    return (
        ...
        <ul className="navbar-nav flex flex-col pl-0 list-style-none ml-auto">
          ...
          <li className="nav-item p-2">
            <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/">Services</Link>
          </li>
          <li className="nav-item p-2">
            <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/">Blog</Link>
          </li>
          <li className="nav-item p-2">
            <Link className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to="/">Contact</Link>
          </li>
