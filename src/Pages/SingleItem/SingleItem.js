...
const SingleItem = ({getPerfume, handleDelete}) => {
    ...
    return (
        <div className=' rounded p-2 m-5 w-3/4 transform scale-110 transition-transform flex justify-between items-center hover:bg-gradient-to-tl from-pink-500 to-white hover:scale-100 border border-pink-500'>
